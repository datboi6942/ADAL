...
DOMAIN_KEYWORDS = {
    ...
    Domain.CHEMISTRY: [
        r"\bsynthes(is|ize|es|izing|is procedure)\b", r"\bmolecule(s|ular)?\b",
        ...
        r"\bpurification\b", r"\b(?:re)?crystalli[sz](?:ation|e)\b", r"\breflux\b",
        ...
        r"\bbromide\b", r"\biodide\b", r"\bfluoride\b",
        r"\baromatic\b", r"\baliphatic\b", r"\bheterocyclic\b",
        r"\bnucleophilic\b", r"\belectrophilic\b", r"\bsubstitution\b",
        r"\belimination\b", r"\bcondensation\b", r"\bhydrolys(is|e|ze)\b",
        r"\bhydrogenat(?:ion|e)\b", r"\bdehydrat(?:ion|e)\b",
        r"\banhydrous\b", r"\binert[\s-]?atmosphere\b", r"\bunder[\s-]?(argon|nitrogen)\b",
        r"\bgrignard\b", r"\bwittig\b", r"\bdiels[\s-]?alder\b",
        r"\bfriedel[\s-]?crafts\b", r"\baldol\b",
        r"\blaboratory\b", r"\bflask\b", r"\bbeaker\b",
        r"\bround[\s-]?bottom\b", r"\bcondenser\b", r"\bseparatory[\s-]?funnel\b",
